...
CREATE TABLE `entry` (
  ...
  `goodsname` char(50) NOT NULL COMMENT '商品名称',
  ...
  PRIMARY KEY (`entryid`),
  UNIQUE KEY `goodsno_2` (`goodsno`,`adddate`),
  KEY `goodsno` (`goodsno`)
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('3', '001', '1', '4', '2', '', '测试', '', '0.00', '95', '', '', '1375024223', '0');
INSERT INTO `goods` VALUES ('4', '002', '1', '5', '3', '', '测试1', '', '0.00', '2', '', '', '1375024261', '0');
INSERT INTO `goods` VALUES ('5', '021', '1', '5', '2', '', '商品2', '', '0.00', '7', '', '', '1375197875', '0');
INSERT INTO `goods` VALUES ('6', '022', '1', '6', '3', '', '商品22', '', '12.00', '100', '', '', '1375197891', '1389625244');
INSERT INTO `goods` VALUES ('7', '003', '1', '5', '2', '', '啊的所发生的指甲油', '', '11.00', '5', '', '', '1375284314', '1389625244');
