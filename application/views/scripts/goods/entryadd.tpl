<div class="main container" id="<*$controller*>">
  <div class="row">
    ...
    <h2>增加进货单</h2>
      ...
      <form onsubmit="return checkit();" action="/<*$controller*>/opentryadd" method="post" class="form-horizontal" >
        <table class="table">
          <tr>
            <th  class="span2">&nbsp;</th>
          ...
          <tr class="text-error">
            ...
            <td colspan="3"><label class="control-group error"><input type="text" name="goodsnum" value="1" class="input-small" id="goodsnum" placeholder="" onkeyup="calAll()"/></label><div><small id="readme4" class="label-warning"></small></div></td>
          </tr>
          <tr class="text-error">
            <th >进货价 <i class="icon-star"></i></th>
            <td colspan="3"><label class="control-group error">
                <input type="text" name="inprice" value="0" class="input-small " id="inprice" placeholder="进货价" onkeyup="calAll()"/>
                &nbsp;&nbsp;元&nbsp;<small id="readme5" class="text-info">&nbsp;&nbsp;(进货价不能大于零售价),保存后将不能更改</small></label>
...
function checkit(){
	...
	if(inprice=='0' || inprice=='' || inprice=='0.0'|| inprice=='0.00'){
		$('#readme2').html('不能为0');
