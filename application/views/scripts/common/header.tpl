  ...
  <form action="/user/opchangepassword" method="post" class="form-horizontal">
    ...
    <div class="modal-body">
      <div class="control-group">
        ...
        <div class="controls">
          <input type="password" name="oldpassword" value=""  class="input-medium" id="oldpassword" placeholder="输入旧密码" />
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="password" name="newpassword" value=""  class="input-medium" id="newpassword" placeholder="输入新密码" />
          <label class="help-inline"></label>
        </div>
      </div>
      <div class="control-group">
        ...
        <div class="controls">
          <input type="password" name="repassword" value="" class="input-medium" id="repassword" placeholder="重复密码" />
          <label class="help-inline"></label>
        </div>
      </div>
    </div>
